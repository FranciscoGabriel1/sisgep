                    ...
                    <div class="card">
                        <div class="card-body  py-3 text-justify">
                            ...
                            <div class="text-center py-2 card-text">
                                <a class="container-fluid" title="Clique para acessar"
                                   href="page-publicacao.php?id_publicacao=<?php echo $rows_publicacoes['idPublicacao']; ?>&descricao=<?php echo $rows_publicacoes['descricao']; ?>&postador=<?php echo $_SESSION['user_id'] ?>"><?php echo $rows_publicacoes['numeroProcesso']; ?>
								</a>
                        ...
                        <div class="card-footer">
                            <form method="post" class="form_excluir text-center">
                                ...
                                <button type="submit" title="Excluirá o processo incluindo todos os documentos anexados." name="excluirprocesso" class="btn btn-danger">Excluir </button>
                            </form>
                            <?php //}				
                            ?>
                        </div>
