...
<!-- Editable table -->
    <h4 class="card-header text-center font-weight-bold text-success py-4">Gerenciamento de senha dos administradores e seus Departamentos/Setores</h4>
    <div class="card-body">
            ...
            <table class="table table-bordered table-responsive-md table-striped text-center">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                                <form method="POST" data-toggle="modal" data-target="#msg-alterar-senha" href="#" style="color: white";">
                                    <input name="id_paraalterar" type="hidden" value=""/>
                                        <span class="table-remove">
                                            <button name="botaoalterar" type="button" class="btn btn-success btn-rounded btn-sm my-0">Alterar</button>
                                        </span>
                                </form>
                        </td>
                    </tr>
